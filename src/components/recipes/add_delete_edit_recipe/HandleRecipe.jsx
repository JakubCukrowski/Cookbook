...
// import { DataWrapper } from "../../../assets/styles/DataWrapper";
// import { NewRecipeContainer } from "../../../assets/styles/Containers";
// import { ButtonsContainer, ButtonWrapper } from "../../../assets/styles/RecipesStyles";
...
//     if (
//       currentStepIndex <
//         steps.indexOf(steps[steps.length - 1]) &&
//       newRecipeDetails.name.length >= 8 &&
...
//             {h2Text} przepis {currentStepIndex + 1} / {steps.length}
//           </h2>
...
import {
  ButtonsContainer,
  ButtonWrapper,
} from "../../../assets/styles/RecipesStyles";
import { useNavigate } from "react-router-dom";
import profanity from "../../../profanity.json";
import { deleteDoc, doc } from "firebase/firestore";
import { UserAuth } from "../../../context/AuthContext";
...
export const HandleRecipe = ({
  ...
  const stepTitles = ["Dane", "Składniki", "Przygotowanie", "Wybierz tagi"];
  ...
  const validateFirstStep = (e) => {
    ...
    if (
      currentStepIndex < steps.indexOf(steps[steps.length - 1]) &&
      newRecipeDetails.name.length >= 8 &&
      newRecipeDetails.image !== "" &&
      newRecipeDetails.category !== "" &&
      newRecipeDetails.category !== "wybierz" &&
    ...
    <NewRecipeContainer>
      <DataWrapper>
        <Container>
          ...
          <Stepper activeStep={steps[currentStepIndex]} sx={{marginBottom: '50px'}}>
            {steps.map((_, index) => {
              return (
                <Step key={index} completed={currentStepIndex > index}>
