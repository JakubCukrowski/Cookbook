...
export const SignUp = () => {
  ...
  const handleInputs = (e) => {
    ...
    setInputErrors(prev => {
      return {
        ...
        password: (name === "password" || name === "repeatedPassword") ? false : prev.password,
        repeatedPassword: (name === "password" || name === "repeatedPassword") ? false : prev.repeatedPassword
      }
  ...
  return (
    <StyledSignSection>
      <StyledLink color="white" style={{ padding: 20 }} to="/">
        ...
        <StyledForm noValidate onSubmit={handleSubmit}>
          <Form.Group className="mb-3" controlId="formGroupId">
            ...
            <Alert show={inputErrors.displayName} variant="danger">
              Nazwa użytkownika jest za krótka. Nazwa musi posiadać minimalnie 6
              znaków
            </Alert>
            <Form.Control
              autoComplete="off"
          ...
          <Form.Group className="mb-3" controlId="formGroupEmail">
            ...
            <Form.Control
              ...
              isValid={
                !inputErrors.email && userCredentials.email.match(emailRegex)
              }
              onChange={handleInputs}
              name="email"
          ...
          <Form.Group className="mb-3" controlId="formGroupPassword">
            ...
            <Alert
              show={inputErrors.password && userCredentials.password.length < 6}
              variant="danger"
            >
